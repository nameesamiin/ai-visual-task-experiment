...
DEBRIEF_SECTIONS = [
    ...
    ("Contact for further information", "Kindly send an email to s5822244@bournemouth.ac.uk after completion to receive your credits :) If you have any questions or would like further information, please contact the researcher at s5822244@bournemouth.ac.uk, or the supervisor at ayankouskaya@bournemouth.ac.uk."),
...
if page == "welcome":
    ...
    if st.button("Next"):
        worksheet = get_questionnaire_sheet()
        total = 0
